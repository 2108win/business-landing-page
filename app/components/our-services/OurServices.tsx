...
const OurServices = () => {
  return (
    <div className="h-full md:mt-40 mt-16 flex flex-col gap-8 md:gap-10 px-4">
      <Heading
        title="Our Services"
      ...
      />
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-x-[30px] md:gap-y-[40px] md:w-fit mx-auto">
        <Card
